...
app.get("/compose", (req, res)=>{
  res.render("compose", {text : null});
});

app.get("/posts/:title", function(req, res){
  const foundPost = posts.find(r => _.lowerCase(r.title) === _.lowerCase(req.params.title));
  // console.log(posts + ">>>>>>>>" + foundPost);
  if(foundPost)
...
app.post("/compose", (req, res)=>{
  const post = new Post({title: req.body.txt_title, text: req.body.txt_post});
  post.save();
